...
public class AccountService {
	...
	public Response getAccountInfo(@QueryParam("offset") int offset, @QueryParam("count") int count) {
	...
	@Path("/lists")
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getAccountLists(@QueryParam("offset") int offset, @QueryParam("count") int count) {
	...
	@Path("/rated/movies")
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getAccountRatedMovies(@QueryParam("offset") int offset, @QueryParam("count") int count) {
		HashMap<String, Object> hm = new HashMap<String, Object>();
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getAccountFavoriteMovies(@QueryParam("offset") int offset, @QueryParam("count") int count) {
		HashMap<String, Object> hm = new HashMap<String, Object>();
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getAccountWatchListMovies(@QueryParam("offset") int offset, @QueryParam("count") int count) {
		HashMap<String, Object> hm = new HashMap<String, Object>();
	...
	@Path("/rate/movie")
	@Produces({ MediaType.APPLICATION_JSON })
	public Response postMovieRating(@QueryParam("offset") int offset, @QueryParam("count") int count, 
			@QueryParam("movieid") int movieid, @QueryParam("rating") int rating) {
		HashMap<String, Object> hm = new HashMap<String, Object>();
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public Response addFavoriteMovie(@QueryParam("offset") int offset, @QueryParam("count") int count, 
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public Response addWatchlistMovie(@QueryParam("offset") int offset, @QueryParam("count") int count, 
			@QueryParam("movieid") int movieid) {
		HashMap<String, Object> hm = new HashMap<String, Object>();
