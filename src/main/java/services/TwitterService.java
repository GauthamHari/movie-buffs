...
public class TwitterService {
	...
	String consumerSecret = "";  // Add consumer secret
	...
	public String success(@QueryParam("oauth_token") String otoken,
		...
		try {
			tweetStatus = twitter.updateStatus("Registration message from Gautham Hari's heroku app 'movie-buffs'."
	...
	public String success(@QueryParam("user") String user) {
		...
		try {
			tweetStatus = twitter.updateStatus("Status Update from Gautham Hari's Heroku app 'movie-buffs'"
					+ System.currentTimeMillis());
		} catch (TwitterException e) {
			e.printStackTrace();
		}
